...
// {
// 	{
// 		string fullname = "Jim Kerry";
// 		int year = 1900;

// 		Person p;
// 		p.ChangeFirstName(year, "Jim");
// 		p.ChangeLastName(year, "Kerry");

// 		AssertEqual(p.GetFullName(year), fullname, "in 1900 - Jim Kerry");
// 	}
// 	{
// 		string fullname = "Jim Kerry";
// 		int year = 1900;
...
// 		Person p;
// 		p.ChangeFirstName(year - 8, "Jim");
// 		p.ChangeLastName(year, "Kerry");

// 		AssertEqual(p.GetFullName(year), fullname, "in 1900 - Jim Kerry");
// 	}
// 	{
// 		string fullname = "Incognito";
// 		int year = 1900;
...
// 		AssertEqual(p.GetFullName(year), fullname, "in 1900 - Jim");
// 		fullname += " Kerry";
// 		AssertEqual(p.GetFullName(year + 10), fullname, "in " + to_string(year) + " - " + fullname);
// 	}
// 	{
// 		string fullname = "Kerry";
// 		int year = 1900;

// 		Person p;
// 		year += 8;
// 		p.ChangeFirstName(year, "Jim");
// 		p.ChangeLastName(year - 8, "Kerry");

// 		AssertEqual(p.GetFullName(year), fullname, "in 1900 - Kerry");
// 		fullname += " Jim";
// 		AssertEqual(p.GetFullName(year), fullname, "in " + to_string(year) + " - " + fullname);
// 	}
// }
...
int main()
{
	...
	runner.RunTest(TestAddNameDiffYear, "TestAddNameDiffYear");
